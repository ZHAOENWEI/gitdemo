<template>
    <div>
        ...
        <el-card class="mt">
            <el-row>
                <el-col :span="12">
                    <span style="font-size: 14px;line-height: 40px;">运单编号:{{no}}&nbsp;&nbsp;&nbsp;创建时间:2022-08-24&nbsp;&nbsp;&nbsp;审核员:张三丰</span>
                </el-col>
        ...
        <el-card class="mt">
            ...
            <el-row>
                <el-row>
                    <el-col class="title">运输信息</el-col>
                </el-row>
                <el-row class="mt">
                    <el-col :span="6">
                        <p>车牌号:京A12345</p>
            ...
            <el-row>
                <el-row>
                    <el-col class="title">经办人员信息</el-col>
                </el-row>
                <el-row class="mt">
                    <el-col :span="6">
                        <p>业务员:张三</p>
...
/* 
    ...
    include:包含
    exclude:排除 除了。。。
        <keep-alive :include="组件名/['组件名','组件名']" exclude="组件名">
